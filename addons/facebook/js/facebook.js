...
var Facebook = Class(lib.PubSub, function () {
	...
	*/
	...
	this.postScore = function(opts, cb){
		pluginImpl.request("postScore", {"score": opts}, cb);
	//	pluginImpl.request("postScore", opts, cb);
	};
	this.viewScores = function (query, cb){
		pluginImpl.request("viewScores", {"fields": query}, cb);
	}
});
